    ...
    return (
        <>
            <div className='bg-[#D496BB] min-h-screen'>
                ...
                <div className='px-4 sm:px-8 md:px-16 lg:px-32 max-w-7xl mx-auto'>
                    <h1 className='text-5xl xl:text-7xl font-bold text-center mt-8 text-white'> Harmonia </h1>
                    <p className='text-desc font-bold text-center text-white'> Your Personal Music Diary </p>
                    {/* split div, about section */}
                    <div className='flex flex-row items-stretch justify-center mt-12'>
                        {/* image */}
                        <div className='w-1/2 bg-white flex items-center justify-center rounded-l-2xl shadow-md'>
                            <img src={icon} alt="Amber" className="w-full h-full object-fit"></img>
                        </div>
                        {/* text */}
                        <div className=' w-1/2 bg-[#EFBFE9] text-[#934774] px-12 rounded-r-2xl shadow-md'>
                            <h2 className='text-center my-8 font-bold md:text-2xl text-md'> What is Harmonia? </h2>
                            <p className='text-sm md:text-base'>
                                ...
                                <br /><br />
                                With Harmonia, you can easily add albums to your profile, view your album collection, and keep track of your listening history. Whether you’re a casual listener or a music enthusiast, Harmonia is the perfect app to organize your music collection!!
                            </p>
                    ...
                    <h2 className='text-center my-8 font-bold text-3xl xl:text-6xl text-white'> How Harmonia Works? </h2>
                    {/* laptop screens have the components in a rows */}
                    {/* mobile screens have the components in a columns */}
                    <div className='w-full flex flex-col xl:flex-row gap-6 mt-12 pb-12 items-center'>
                        <div className='w-full xl:w-1/3 xl:h-96 h-auto bg-white flex justify-center pt-8 px-8 shadow-md rounded-2xl transform duration-300 ease-in-out hover:shadow-2xl hover:-translate-y-2 hover:scale-105'>
                    ...
                    <h2 className='text-center my-8 font-bold text-4xl xl:text-6xl text-white'>  Meet the Devs </h2>
                    <div className='gap-6 flex flex-wrap lg:flex-nowrap items-center justify-center py-12'>
